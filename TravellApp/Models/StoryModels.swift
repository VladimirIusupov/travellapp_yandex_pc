...
public extension Story {
    static let mock: [Story] = [
        .init(imageName: "story1", title: "Text Text Text Text", subtitle: "Text Text Text Text Text…", duration: 5),
        .init(imageName: "story2", title: "Text Text Text",       subtitle: "Text Text Text Text…",   duration: 5),
