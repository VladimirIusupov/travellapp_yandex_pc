...
extension CarriersListViewModel {
    static let mockCarriers: [CarrierItem] = [
        ...
        .init(logoSystemName: "train.side.front.car",
              ...
              depTime: "12:20",
              arrTime: "21:00",
              duration: "8 часов 40 мин"),
        .init(logoSystemName: "leaf.fill",
              name: "ЭкоКарго",
              subtitle: "С пересадкой в Бологое",
              depTime: "13:40",
              arrTime: "22:35",
              duration: "8 часов 55 мин"),
        .init(logoSystemName: "cube.box.fill",
              name: "CargoOne",
              subtitle: nil,
              depTime: "15:05",
              arrTime: "23:50",
              duration: "8 часов 45 мин"),
        .init(logoSystemName: "flag.checkered",
              name: "Регион Транс",
              subtitle: nil,
              depTime: "18:30",
              arrTime: "03:15",
        ...
        .init(logoSystemName: "train.side.front.car",
              ...
              depTime: "20:10",
              arrTime: "05:55",
              duration: "9 часов 45 мин"),
        .init(logoSystemName: "bolt.horizontal.circle",
              name: "ФГК",
              subtitle: nil,
              depTime: "21:25",
              arrTime: "06:00",
              duration: "8 часов 35 мин"),
        .init(logoSystemName: "drop.fill",
              name: "Урал логистика",
              subtitle: nil,
              depTime: "22:30",
